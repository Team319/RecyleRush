 ...
 *
 */
public class AutoReleaseTotesAndLiftContainer extends CommandGroup {
    
    public  AutoReleaseTotesAndLiftContainer() {
        
    	
    	addSequential(new ToteClawOpen());
    	addSequential(new AutoElevatorLiftContainerFromAutoStack());

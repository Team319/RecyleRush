 ...
 *
 */
public class  AutoElevatorTwoInchPosition extends Command {

    public AutoElevatorTwoInchPosition() {
    ...
    protected void initialize() {
    	...
    	Robot.elevator.twoInchElevatorPosition();
    }
    ...
    protected boolean isFinished() {
    	//if elevator is above this value, it's safe to drive forward in auto
    	return Robot.elevator.encoderPosition() > 200;
    }

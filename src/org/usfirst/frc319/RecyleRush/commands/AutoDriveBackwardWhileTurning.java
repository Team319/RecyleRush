 ...
 *
 */
public class  AutoDriveBackwardWhileTurning extends PIDCommand {
	
	double desiredAngle = 0;
    public AutoDriveBackwardWhileTurning(double degrees) {
    ...
    protected void initialize() {
    	...
    	this.setSetpoint(Robot.driveTrain.getDegreesFromEncoderValues() + desiredAngle);// was 105 2/27/15

 ...
 *
 */
public class  ActiveCollectorCollect extends Command {

    public ActiveCollectorCollect() {
    ...
    protected void initialize() {
    	System.out.println("Collecting Collector");
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	Robot.activeCollector.collect(0.75);
    }

 ...
 *
 */
public class  AutoSwingRotateLooseToleranceWhileKeepingTote extends PIDCommand {
	double setpoint = 0;
	double rightSpeed =0;
	static double P = 0.1;//was 0.075
	static double I = 0.007; //Was 0.005
	static double D = 0.75;
	
    public AutoSwingRotateLooseToleranceWhileKeepingTote(double rightPower, double inches) {
    	
        super("AutoRotate", P, I, D, 0.02); // was 0.25... then 0.1
        getPIDController().setContinuous(false);
        getPIDController().setAbsoluteTolerance(2.0);// was 1.0
        

    
        setpoint = inches;
        rightSpeed =rightPower;
    ...
    protected void usePIDOutput(double output) {
    	...
    	Robot.driveTrain.leftDrivetrain(output);
    	//Robot.driveTrain.manualArcadeDrive(0, output);//change to left motor
    }
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.rightDrivetrain(-rightSpeed);

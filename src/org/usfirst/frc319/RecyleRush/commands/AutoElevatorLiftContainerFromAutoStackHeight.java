 ...
 *
 */
public class  AutoElevatorLiftContainerFromAutoStackHeight extends Command {

    public AutoElevatorLiftContainerFromAutoStackHeight() {
    ...
    protected void initialize() {
    	...
    	Robot.elevator.goToPosition(8700);
    }

 ...
 *
 */
public class  AutoDriveBackwardUntilDistanceIsReached extends Command {

	double initialDistance = 0;
	double desiredDistance = 0;
    public AutoDriveBackwardUntilDistanceIsReached(double inches) {
    ...
    protected void execute() {
    	...
    	Robot.driveTrain.manualArcadeDrive(0.5, 0);

 ...
 *
 */
public class ToteLights extends Subsystem {
    ...
    //	setDefaultCommand(new ToteLightsFunction());
        //setDefaultCommand(new MySpecialCommand());
    }
    
    public void LightUpWhenToteIsInPosition(){
    	if(Robot.elevator.isToteInCollector){
